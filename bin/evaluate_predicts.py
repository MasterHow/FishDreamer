...
from saicinpainting.evaluation.evaluator import InpaintingEvaluator, lpips_fid100_f1, ssim_fid100_f1, ssim_psnr100_f1,\
    ssim_psnr100_miou_f1
from saicinpainting.evaluation.losses.base_loss import SegmentationAwareSSIM, \
    SegmentationClassStats, SSIMScore, LPIPSScore, FIDScore, mIoUScore, PSNRScore, SegmentationAwareLPIPS,\
...
def main(args):
    ...
    evaluator = InpaintingEvaluator(dataset, scores=metrics,
                                    integral_title='ssim_psnr100_miou_f1', integral_func=ssim_psnr100_miou_f1,
