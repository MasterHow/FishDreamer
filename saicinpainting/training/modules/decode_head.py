...
class BaseDecodeHead(nn.Module, metaclass=ABCMeta):
    ...
    def __init__(self,
                 in_channels = [96, 192, 384, 768],     # tiny small
    ...
    def _init_inputs(self, in_channels, in_index, input_transform):
        ...
        self.in_index = in_index
        if input_transform is not None:
            # assert isinstance(in_channels, (list, tuple))     # could be ListConfig from yaml
            # assert isinstance(in_index, (list, tuple))       # could be ListConfig from yaml
